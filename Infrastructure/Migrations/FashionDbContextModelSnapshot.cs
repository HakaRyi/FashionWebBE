...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.EscrowSession", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.EventCriterion", b =>
                {
                    b.Property<int>("EventCriterionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("event_criterion_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("EventCriterionId"));
                    ...
                    b.HasKey("EventCriterionId");

                    b.HasIndex("EventId");

                    b.ToTable("Event_criteria", "public");
                });

            modelBuilder.Entity("Domain.Entities.EventExpert", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.EventWinner", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.ExpertCriterionRating", b =>
                {
                    b.Property<int>("ExpertCriterionRatingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("expert_criterion_rating_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ExpertCriterionRatingId"));
                    ...
                    b.HasKey("ExpertCriterionRatingId");

                    b.HasIndex("EventCriterionId");

                    b.HasIndex("ExpertRatingId");

                    b.ToTable("Expert_criterion_ratings", "public");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ExpertRating", b =>
                {
                    b.Property<int>("ExpertRatingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Domain.Entities.ExpertRequest", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.MessReaction", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.OutfitItem", b =>
                {
                    b.Property<int>("OutfitId")
                        .HasColumnType("integer")
                        .HasColumnName("outfit_id");
            ...
            modelBuilder.Entity("Domain.Entities.PinnedMessage", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.PostVector", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("integer")
                        .HasColumnName("post_id");
            ...
            modelBuilder.Entity("Domain.Entities.PrizeEvent", b =>
                {
                    b.Property<int>("PrizeEventId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Domain.Entities.ReputationHistory", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.TryOnHistory", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.UserProfileVector", b =>
                {
                    b.Property<int>("AccountId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Domain.Entities.Wardrobe", b =>
                {
                    b.Property<int>("WardrobeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Domain.Entities.EscrowSession", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Order", "Order")
                        ...
                        .HasForeignKey("Domain.Entities.EscrowSession", "OrderId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Domain.Entities.EventWinner", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.PrizeEvent", "PrizeEvent")
                        .WithMany("EventWinners")
            ...
            modelBuilder.Entity("Domain.Entities.ExpertCriterionRating", b =>
                {
                    b.HasOne("Domain.Entities.EventCriterion", "EventCriterion")
                        .WithMany("CriterionRatings")
                        .HasForeignKey("EventCriterionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_expert_criterion_ratings_criterion");

                    b.HasOne("Domain.Entities.ExpertRating", "ExpertRating")
                        .WithMany("CriterionRatings")
                        .HasForeignKey("ExpertRatingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_expert_criterion_ratings_rating");

                    b.Navigation("EventCriterion");

                    b.Navigation("ExpertRating");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ExpertProfile", b =>
                {
                    b.HasOne("Domain.Entities.Account", "Account")
                        ...
                        .HasForeignKey("Domain.Entities.ExpertProfile", "AccountId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Domain.Entities.Item", b =>
                {
                    b.HasOne("Domain.Entities.Wardrobe", "Wardrobe")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Domain.Entities.MessReaction", b =>
                {
                    b.HasOne("Domain.Entities.Account", "AccountReact")
            ...
            modelBuilder.Entity("Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Account", "Seller")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.PinnedMessage", b =>
                {
                    b.HasOne("Domain.Entities.Account", "AccountPinned")
            ...
            modelBuilder.Entity("Domain.Entities.PostVector", b =>
                {
                    b.HasOne("Domain.Entities.Post", "Post")
                        .WithOne("PostVector")
                        .HasForeignKey("Domain.Entities.PostVector", "PostId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Domain.Entities.PrizeEvent", b =>
                {
                    b.HasOne("Domain.Entities.EscrowSession", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.RefundRequest", b =>
                {
                    b.HasOne("Domain.Entities.Order", "Order")
                        ...
                        .HasForeignKey("Domain.Entities.RefundRequest", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Scoreboard", b =>
                {
                    b.HasOne("Domain.Entities.Post", "Post")
                        .WithOne("Scoreboard")
                        .HasForeignKey("Domain.Entities.Scoreboard", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Domain.Entities.UserProfileVector", b =>
                {
                    b.HasOne("Domain.Entities.Account", "Account")
                        ...
                        .HasForeignKey("Domain.Entities.UserProfileVector", "AccountId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Domain.Entities.Wardrobe", b =>
                {
                    b.HasOne("Domain.Entities.Account", "Account")
                        .WithOne("Wardrobe")
                        .HasForeignKey("Domain.Entities.Wardrobe", "AccountId")
                        .IsRequired()
