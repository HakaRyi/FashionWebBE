    ...
    public class OrderService : IOrderService
    {
        ...
        private async Task CompleteOrderAndReleaseEscrowAsync(Order order, int actorId, bool isSystemAction = false)
        {
            ...
            await SaveEscrowStatusHistoryAsync(
                ...
                reason: isSystemAction
                    ? "Automated release by system timeout."
                    : "Buyer confirmed delivery. Funds dispersed to Seller and Admin.");
            ...
            await SaveStatusHistoryAsync(
                ...
                isSystemAction
                    ? "Order automatically completed by system timeout."
                    : "Buyer confirmed successful delivery. Order marked as completed.");
